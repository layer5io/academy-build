...
require (
	...
	github.com/layer5io/digitalocean-academy v0.1.8 // indirect
	github.com/layer5io/exoscale-academy v0.6.16 // indirect
	github.com/layer5io/layer5-academy v0.6.2 // indirect
