...
require (
	...
	github.com/layer5io/exoscale-academy v0.6.18 // indirect
	github.com/layer5io/layer5-academy v0.8.1 // indirect
	github.com/meshery-extensions/meshery-academy v0.3.4-0.20251015000352-b1ae58bac392 // indirect
